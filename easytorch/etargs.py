...
default_args.add_argument('-ph', '--phase', default=None, choices=['train', 'test'], type=str, help='Can be train/test.')
...
default_args.add_argument('-nw', '--num_workers', default=4, type=int, help='Number of workers to work on data loading.')
default_args.add_argument('-data', '--dataset_dir', default='', type=str, help='Root path to input Data.')
...
default_args.add_argument('-pt', '--pretrained_path', default=None, type=str, help='Full path to pretrained weights. It will be '
                                                                         'loaded before training.')
default_args.add_argument('-v', '--verbose', default=True, type=boolean_string, help='Prints information on different steps.')
...
default_args.add_argument('-rt', '--split_ratio', default=[0.6, 0.2, 0.2], nargs='*', type=float, help='Split ratio.')
